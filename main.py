...
from utils.db_handler import setup_db
...
class VoidBot(commands.Bot):
        ...
        for filename in os.listdir('./cogs'):
            if filename.endswith('.py') and filename != "__init__.py":
                try:
                    ...
                    print(f"❌ [ERRO CRÍTICO] O Gui avisou que deu ruim no {filename}: {e}")
        print("=" * 50)
    ...
    async def mudar_status_balao(self):
        ...
        frases_balao = [
            ...
            "Arthur liberou o acesso do Serasa.",
            "By: Gui, Marcele e Arthur.",
            "Passa o daily senão o Gui te quebra.",
            "Marcele tá Clonado teu cpf.",
            "Arthur Morgan hackeou seu IP.",
